...
Before continuing, make sure that you have the <a href="/docs/getting-started/quickstart">Flowbite JavaScript file</a> included in your project in order to make the tooltip component work.
...
If you're using the <a href="/docs/getting-started/typescript">TypeScript configuration</a> from Flowbite then you can import the types for the Tooltip class, parameters and its options.
