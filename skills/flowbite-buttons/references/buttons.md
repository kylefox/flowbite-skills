...
Use the Tailwind CSS button component inside forms, as links, and more with support for multiple colors, sizes, and variations
...
Use the following <a href="/docs/components/spinner">spinner components</a> from Flowbite to indicate a loader animation inside buttons:
