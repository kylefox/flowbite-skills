...
Please check out the <a href="/docs/components/alerts#javascript-behaviour">Dismiss object</a> documentation to learn how to programmatically work with the toast component directly from JavaScript.