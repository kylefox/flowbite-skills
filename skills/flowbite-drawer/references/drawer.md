...
To enable interactivity via data attributes and the Drawer API you need to include [Flowbite's JavaScript file](/docs/getting-started/quickstart).
...
If you're using the <a href="/docs/getting-started/typescript">TypeScript configuration</a> from Flowbite then you can import the types for the Drawer (off-canvas) class, parameters and its options.
